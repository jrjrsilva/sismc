...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null,"Maria jose","jr_jrsilva@hotmail.com","25016061599",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("13269856","96328754"));
		
		Cliente cli2 = new Cliente(null,"Ana Maria","jrjrsilva@gmail.com","47217706424",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("998560987","931425634"));
		...
		Endereco e3 = new Endereco(null,"Av Central","10","Lt 15","Centro","26876543",cli2,c3);
