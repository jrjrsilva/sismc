...
public class SismcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null,"Escritorio 3");
		Categoria cat4 = new Categoria(null,"Escritorio 4");
		Categoria cat5 = new Categoria(null,"Escritorio 5");
		Categoria cat6 = new Categoria(null,"Escritorio 6");
		Categoria cat7 = new Categoria(null,"Escritorio 7");
		Categoria cat8 = new Categoria(null,"Escritorio 8");
		Categoria cat9 = new Categoria(null,"Escritorio 9");
		Categoria cat10 = new Categoria(null,"Escritorio 10");
		Categoria cat11 = new Categoria(null,"Escritorio 11");
		Categoria cat12 = new Categoria(null,"Escritorio 12");
